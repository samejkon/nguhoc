                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="footer-logo">
                            <img width="50%" src="{{ asset('img/logo/king.png') }}" alt="Footer Logo">
                            <p class="info mt-15">
                                Chuyên cung cấp điện thoại, học tập, đồ họa, chơi game.
                            </p>
                        </div>
                        <ul class="des">
                            <li>
                                <span>Địa chỉ: </span><a href="{{route('lienhe')}}">525A Điện Biên Phủ, TP Đà Nẵng</a>
                            </li>
                            <li>
                                <span>SĐT: </span>
                                <a href="tel: 0901234567">090.xxx.xnxx (võ Ngọc Hiếu)</a>
                            </li>
                            <li>
                                <span>Email: </span>
                                <a href="mailto: support@shopvitinh.com">Support@shopdienthoai.com</a>
                            </li>
                        </ul>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li><i class="fa fa-phone"></i> Phòng Kinh Doanh: <p class="footer-lienhe">090.xxx.xnxx (Võ Ngọc Hiếu)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Chăm Sóc Khách Hàng: <p class="footer-lienhe">090.xxx.xnxx (Võ Ngọc Hiếu)</p>
                                </li>
                                <li><i class="fa fa-phone"></i> Bảo Hành: <p class="footer-lienhe">090.xxx.xnxx (Võ Ngọc Hiếu)</p>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                        <div class="footer-block">
                            ...
                            <ul>
                                <li>Showroom<p class="footer-lienhe">8h30 - 19h00 (Mỗi ngày)</p>
                                </li>
                                <li>Bảo Hành<p class="footer-lienhe">10h00 - 15h00 (T2-T6)</p>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<!-- Popper js -->
<script src="{{ asset('js/frontend/vendor/popper.min.js') }}"></script>
...
<!-- Barrating -->
<script src="{{ asset('js/frontend/jquery.barrating.min.js') }}"></script>
<!-- Jquery-ui -->
...
@if (!empty(session('thongbao')) || $errors->any())
    <script>
        $(window).load(function() {
            alert("{{ !empty(session('thongbao')) ? session('thongbao') : 'Thao tác thất bại, vui lòng thử lại!'}}");
        });
    </script>
@endif
