                                ...
                                <div class="tab-content" id="myaccountContent">
                                    ...
                                    <div class="tab-pane fade {{ auth()->check() && auth()->user()->roles == 2 ? 'khonghienthi' : 'active show' }}"
                                        ...
                                        <div class="myaccount-content">
                                            @if (
                                                !empty($danhSachPhieuXuat) &&
                                                    !empty($danhSachChiTietPhieuXuat) &&
                                                    !empty($danhSachThuVienHinh) &&
                                                    !empty($danhSachSanPham))
                                                ...
                                                @else
                                                    <div id="danhSachDonHang">
                                                        ...
                                                        @if (!empty($danhSachPhieuXuat) && count($danhSachPhieuXuat) > 0)
                                                            <div class="myaccount-table table-responsive text-center">
                                                                                ...
                                                                                <td class="canphai">
                                                                                    @if (!empty($danhSachMaGiamGia) && !empty($phieuXuat->id_discount))
                                                                                        @foreach ($danhSachMaGiamGia as $maGiamGia)
                                                                                            @if ($maGiamGia->id_discount == $phieuXuat->id_discount)
                                                                                                @php
                                                                                                    $phieuXuat->total_money -=
                                                                                                        $maGiamGia->reduced_price;
                                                                                                    break;
                                                                                                @endphp
                                                                                            @endif
                                                                                        @endforeach
