        ...
        <div class="container">
            <div class="breadcrumb-content">
                <ul>
                    ...
                    <li><a
                            href="{{ $sanPhamXem->cat_products == 0 ? url('danhsachsp?loaisp=0') : url('timkiem?boloc=-2') }}">{{ $sanPhamXem->cat_products == 0 ? 'Điện thoại' : 'Phụ kiện' }}</a>
                    </li>
                    <li class="active"><a
                    ...
                    <div class="product-details-view-content sp-sale-content pt-60">
                        <div class="product-info">
                            ...
                            @if ($sanPhamXem->cat_products == 0)
                                <p class="product-details-ref mb-0">Loại: Điện thoại</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="featured-product pt-60">
                        <div class="li-section-title">
                            <h2>
                                <span>Điện thoại cũ giá rẻ</span>
                            </h2>
                        </div>
