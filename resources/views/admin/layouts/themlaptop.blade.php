            ...
            <form action="{{ route('xulylaptop') }}" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control" name="cardDoHoa" required>
                                    ...
                                    @if (old('cardDoHoa') != null)
                                        ...
                                        @endif
                                    @endif
                                    <option value="0">Apple Bionic</option>
                                    <option value="1">MediaTek</option>
                        ...
                        <div class="col-md-6 pl-2">
                            <div class="form-group form-group-default">
                                <label style="font-size:12px !important;">Màn hình (5-10 inch)
                                    (*)</label>
                        ...
                        <div class="col-md-6 pr-2">
                            <div class="form-group form-group-default">
                                ...
                                <select class="form-control" name="nhuCau" required>
                                    ...
                                    <option value="Gaming">CPU mạnh</option>
                                </select>
                                @error('nhuCau')
                                    <span style="color: red;font-size:10px">{{ $message }}</span>
                                @enderror
